    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, payload_1.default.init({
                        ...
                        onInit: function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                payload_1.default.logger.info("AI Express server successfully started. Get started by adding a new prompt at ".concat(serverURL, "."));
                                return [2 /*return*/];
                            });
                        }); },
                    })];
            case 1:
                ...
                app.post("/api/update-routes", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
