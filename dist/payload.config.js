...
exports.default = (0, config_1.buildConfig)({
    ...
    admin: {
        ...
        webpack: function (config) {
            config.resolve.fallback = __assign(__assign({}, config.resolve.fallback), { fs: require.resolve("browserify-fs"), child_process: false, stream: require.resolve("stream-browserify"), vm: require.resolve("vm-browserify"), request: require.resolve("browser-request") });
            return config;
        },
    },
    plugins: [],
