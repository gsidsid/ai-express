      ...
      admin: {
        ...
        description: function (_a) {
          ...
          return "".concat(
            typeof value === "string"
              ? "POST "
                  .concat(serverURL, "/api/")
                  .concat((0, util_1.getRouteName)(value))
              : "Required"
          );
        },
      },
      ...
      validate: function (value, _a) {
        ...
        while ((match = regex.exec(value)) !== null) {
          ...
          if (variable.length < 2 || variable.length > 100) {
            return "Please ensure that all variable names are between 2 and 100 characters long. {{"
              .concat(variable, "}} is ")
              .concat(variable.length, " characters long.");
          }
          if (/[\s\W]/.test(variable)) {
            return "Please ensure that all variables do not contain spaces, special characters, or dashes. {{".concat(
              variable,
          ...
          switch (data.model) {
            case "gpt-3.5-turbo":
              if ((0, util_1.countTokens)(value) > 4096) {
                return "Prompt exceeds maximum token length of 4096 tokens (currently ".concat(
                  (0, util_1.countTokens)(value),
                  " tokens)."
                );
              }
              break;
            case "gpt-4":
              if ((0, util_1.countTokens)(value) > 8192) {
                return "Prompt exceeds maximum token length of 8192 tokens (currently ".concat(
                  (0, util_1.countTokens)(value),
                  " tokens)."
                );
              }
            ...
            case "gpt-4-32k":
              if ((0, util_1.countTokens)(value) > 32768) {
                return "Prompt exceeds maximum token length of 32768 tokens. (currently ".concat(
                  (0, util_1.countTokens)(value),
                  " tokens)."
                );
              }
            ...
            },
            {
              ...
              admin: {
                condition: function (_, siblingData) {
                  return siblingData.validationEnabled;
                },
              },
            },
            {
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                condition: function (_, siblingData) {
                  return siblingData.rateLimitEnabled;
                },
              },
            },
            {
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                condition: function (_, siblingData) {
                  return siblingData.redactionEnabled;
                },
              },
            },
          ],
    ...
    afterChange: [
      function (_a) {
        ...
        axios_1.default.post(
          "".concat(serverURL, "/api/update-routes"),
          {},
          {
            headers: {
              "x-api-key": apiKey,
