...
exports.replaceVariable =
  exports.validateOutput =
  exports.redactPII =
  exports.createRateLimiter =
  exports.countTokens =
  exports.getRouteName =
  exports.generateSwaggerSpec =
  exports.apiKeyMiddleware =
  exports.isRole =
  exports.stringify =
  exports.inferVariablesFromPrompt =
    void 0;
  ...
  prompts.forEach(function (prompt) {
    ...
    var properties = variables.reduce(function (acc, variable) {
      ...
      acc[variable.name] = {
        type: "string",
        default:
          (_a = variable.defaultValue) !== null && _a !== void 0 ? _a : "",
        description:
          (_b = variable.description) !== null && _b !== void 0 ? _b : "",
      };
      return acc;
    }, {});
...
var validateOutput = function (validationFunction, result) {
  var validationResult = (0, safe_eval_1.default)(
